...
export interface Element extends Node, Animatable, ChildNode, InnerHTML, NonDocumentTypeChildNode, ParentNode, Slottable {
...
export var GeolocationCoordinates: {
...
export var GeolocationPosition: {
...
export var GeolocationPositionError: {
...
export var ResizeObserverEntry: {
...
export interface SVGElement extends Element, DocumentAndElementEventHandlers, DocumentAndElementEventHandlers, ElementCSSInlineStyle, GlobalEventHandlers, GlobalEventHandlers, HTMLOrSVGElement, SVGElementInstance {
    /** @deprecated */
...
export var SpeechRecognitionErrorEvent: {
...
export var TransformStreamDefaultController: {
...
export var frameElement: Element | null;
...
export var ongamepadconnected: ((this: Window, ev: GamepadEvent) => any) | null;
export var ongamepaddisconnected: ((this: Window, ev: GamepadEvent) => any) | null;
...
export type PermissionName = "accelerometer" | "ambient-light-sensor" | "background-fetch" | "background-sync" | "bluetooth" | "camera" | "clipboard-read" | "clipboard-write" | "device-info" | "display-capture" | "geolocation" | "gyroscope" | "magnetometer" | "microphone" | "midi" | "nfc" | "notifications" | "persistent-storage" | "push" | "speaker";
